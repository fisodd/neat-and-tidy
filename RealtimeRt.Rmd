...
# FIRST_DATE is when to start the charts
FIRST_DATE = "2020-03-02"
# Depending on the data used, choice of a FIRST_DATE may clean up charts
```
...
it's a quick-and-dirty utility function
...
calc_interval <- function(vals, probs, ci=0.95) {
    ...
    if (sum == 0) {
        ...
        # ... but rather than error out, we'll return zeros...
        ml <- 0
        lo <- 0
        hi <- 0
    } else {
